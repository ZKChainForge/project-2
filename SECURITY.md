...
| 0.9.x | Previous | ✅ Critical fixes only | 2025-06-01 |
| 0.8.x | Legacy | ⚠️ Critical fixes only | 2025-03-01 |
| 0.7.x | Legacy | ❌ No support | 2024-12-01 |
| < 0.7 | Deprecated | ❌ No support | Ended |
...
**Previous Release (0.9.x)**
- Critical and high severity fixes
- No new features
- Security patches backported
- Extended support available

**Legacy Releases (0.8.x and older)**
- Critical severity fixes only
- Best-effort support
- Upgrade strongly recommended
- May become unsupported with notice
...
**PGP Key**: [Download Public Key](https://zk-arithmos.dev/pgp-key.asc)

**PGP Fingerprint**: `ABCD 1234 EFGH 5678 IJKL 9012 MNOP 3456 QRST 7890`

We strongly encourage encrypting sensitive vulnerability reports using our PGP key.

#### Alternative Channels

**HackerOne**: [hackerone.com/zkarithmos](https://hackerone.com/zkarithmos)
- Preferred for bug bounty submissions
- Provides secure communication
- Tracks resolution progress

**GitHub Security Advisories**: [Create Advisory](https://github.com/zk-arithmos/zk-arithmos/security/advisories/new)
- For non-critical issues
- Provides collaboration tools
- Integrated with our development process
...
1. **Vulnerability Type**
   - Category (e.g., soundness, zero-knowledge, implementation)
...
6. **Suggested Fix**
   ...
   - Any patches you've developed

7. **Discovery Context**
   - How you discovered the vulnerability
   - Related vulnerabilities you're aware of
   - Any public discussion of the issue

### What to Expect

We are committed to responding promptly and professionally to all security reports.
...
| Resolution plan | 14 days |
| Patch development | Varies by severity |
| Public disclosure | After patch release |

#### Our Commitments

- **Acknowledgment**: We will confirm receipt of your report within 24 hours.
...
- **Confidentiality**: Do not disclose the vulnerability publicly until we've had time to address it.
- **Good Faith**: Do not access, modify, or delete data beyond what's necessary to demonstrate the vulnerability.
- **No Harm**: Do not exploit the vulnerability in production systems or against other users.
- **Cooperation**: Respond to our requests for additional information.
...
2. Only interact with test accounts they own or with explicit permission
3. Do not exploit vulnerabilities beyond demonstrating the issue
4. Report vulnerabilities promptly and work with us on resolution
5. Follow the disclosure guidelines in this policy

If a third party initiates legal action against you for research conducted under this policy, we will make clear that your actions were authorized.
...
We publish security advisories in the following format:

```
Advisory ID: ZKA-YYYY-NNNN
...
Impact:
Assessment of potential impact on users.

Mitigation:
Steps to mitigate the vulnerability before patching.
...
**Description**: Vulnerability allows complete compromise of the cryptographic guarantees.

**Examples**:
- Soundness break allowing false proofs
- Zero-knowledge break revealing witness
...
**Description**: Significant security impact with practical exploitation path.

**Examples**:
- Partial information leakage about witness
- Denial of service in core functionality
- Authentication bypass
- Memory corruption with limited impact

**Response Time**:
- Response within 24 hours
- Patch within 7 days
- Regular disclosure process

#### Medium (CVSS 4.0-6.9)

**Description**: Security impact with limited scope or requiring specific conditions.

**Examples**:
- Side-channel information leakage
- Limited denial of service
- Incorrect error handling with security implications
...
**Description**: Minor security impact or theoretical concern.
...
- May be disclosed with release notes

#### Informational (CVSS 0.0)

**Description**: No direct security impact but relevant to security posture.

**Examples**:
- Documentation improvements for security
- Best practice recommendations
- Future-proofing concerns
- Non-exploitable code issues

**Response Time**:
- Addressed as resources permit
- May be tracked as enhancement

### Past Advisories

| Advisory ID | Title | Severity | Affected | Fixed | CVE |
|-------------|-------|----------|----------|-------|-----|
| ZKA-2024-0001 | Example Advisory | Medium | 0.8.0-0.8.5 | 0.8.6 | CVE-2024-XXXXX |

Full advisories are available at: [github.com/zk-arithmos/zk-arithmos/security/advisories](https://github.com/zk-arithmos/zk-arithmos/security/advisories)
...
| Factor | Multiplier |
|--------|------------|
| Novel attack technique | +50% |
| Detailed remediation provided | +25% |
| Proof of concept included | +25% |
| Multiple related issues | +10% per additional |
| First report of the quarter | +10% |

#### Payment Methods

We can pay bounties via:
...
1. **Follow Responsible Disclosure**: Do not disclose vulnerabilities publicly before they are fixed.

2. **Test Safely**: Only test against your own instances or our designated testing environments.

3. **No Service Disruption**: Do not conduct tests that could disrupt service for other users.

4. **No Data Access**: Do not access, modify, or delete data belonging to others.

5. **One Report Per Issue**: Submit separate reports for separate issues.

6. **First Reporter Wins**: Rewards go to the first reporter of a unique vulnerability.

7. **Quality Matters**: Clear, detailed reports receive higher rewards.

8. **Follow Up**: Respond to our questions and verify fixes when requested.

### Exclusions

The following do not qualify for rewards:

- Duplicate reports (we'll let you know if it's a duplicate)
- Issues you've already disclosed publicly
- Issues found through automated scanners without manual verification
- Vulnerabilities requiring unlikely user interaction
- Issues that require root/admin access you shouldn't have
- Attacks requiring MITM that don't demonstrate new impact
